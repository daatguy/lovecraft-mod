...
public class PotionSimple extends Potion {
	...
	public PotionSimple(boolean isBadEffectIn, int liquidColorIn, int texX,
			int texY) {
	...
	public void renderHUDEffect(PotionEffect effect, Gui gui, int x, int y,
		...
		gui.drawTexturedModalRect((x + 3) / scale, (y + 3) / scale,
	...
	/*
	 * public void register() { REGISTRY.register(9, new
	 * ResourceLocation("nausea"), (new PotionDread(true,
	 * 5578058)).setPotionName("effect.confusion")); }
	 */
